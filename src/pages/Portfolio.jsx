    ...
    <section className="container mt-5">
      ...
      <div className="row">
        <div className="col-md-4 mb-4">
          <Project title="Task Board" image="/assets/task-board.png" deployedLink="https://zoniaramirez.github.io/task-board/" repoLink="https://github.com/zoniaramirez/task-board" />
        </div>
        <div className="col-md-4 mb-4">
          <Project title="Weather Dashboard" image="/assets/Weather-Dashboard.png" deployedLink="https://zoniaramirez.github.io/weather-dashboard/" repoLink="https://github.com/zoniaramirez/weather-dashboard" />
        </div>
        <div className="col-md-4 mb-4">
        ...
        <div className="col-md-4 mb-4">
          <Project title="Random Drink Recipes" image="/assets/project1.png" deployedLink="https://meg-an321.github.io/drink-recipes/" repoLink="https://github.com/meg-an321/drink-recipes" />
        </div>
      </div>
    </section>
  );
